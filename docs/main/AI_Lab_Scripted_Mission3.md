...
12. During IVR, press 2 and ask **What is the store hours?**. In the response you should hear the Scripted AI agent response with the store hours information that you have configured in the Mission 1. 
